      ...
      <section className="about-section" id="about" style={{ padding: "80px 0", borderTop: "1px solid #1f2937" }}>
        ...
        <div className="features-grid">
          <div className="feature-card">
            <div style={{ fontSize: "36px", fontWeight: "800", color: "#6366f1", marginBottom: "12px" }}>342</div>
            <h3>Registered Students</h3>
            <p>active student profiles registered inside this platform</p>
          </div>
          <div className="feature-card">
            <div style={{ fontSize: "36px", fontWeight: "800", color: "#d946ef", marginBottom: "12px" }}>342 / 500</div>
            <h3>Ticket Sales</h3>
            <p>total seats reserved for upcoming events this semester</p>
          </div>
          <div className="feature-card">
            <div style={{ fontSize: "36px", fontWeight: "800", color: "#6366f1", marginBottom: "12px" }}>4</div>
            <h3>Active Events</h3>
